...
* Cantidad  aproximada de personas que observó en lugares públicos (mercado, hospital) luego de la aplicación de las medidas del gobierno. Esto se medirá mediante un indicador categórico ordinal.
...
## Patrones:
* Pudimos notar que la curva de casos totales no muestra un cambio notable entre antes y después de haber tomado cada medida.
