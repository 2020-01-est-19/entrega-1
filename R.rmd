...
```
El coeficiente de correlación biserial puntual es muy bajo y negativo, la tendencia explica que es baja la correlación entre mayor frecuencia de salida promedio y un trabajo de tipo informal.
...
- Otras tendencias que se encontraron fue entre frecuencia de salida y trabajo informal, dado que se encontró una correlación biserial puntual muy baja lo que explica una baja relación entre estas dos variables. 

- El coeficiente para la medida del retiro AFP es negativo y bajo. Esto quiere decir que el comportamiento positivo corresponde a los trabajadores informales. A mayores disminuciones de frecuencia de salida se correlacionan bajo con las personas de trabajo informal.
