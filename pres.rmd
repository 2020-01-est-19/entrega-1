...
Además en los siguientes plots,
la Línea roja representa el promedio y la azul la mediana.


```{r,echo=FALSE,message=FALSE,results="asis"}
repeat_plots("2020-03-05", "2020-03-25", "Declaración de Estado de Emergencia")
repeat_plots("2020-03-08", "2020-03-28", "Aprobación del Padron de Hogares")
